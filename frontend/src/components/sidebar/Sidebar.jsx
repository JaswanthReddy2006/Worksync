...
const Icons = {
  ...
  Tasks: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>,
  ...
  AI: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 1 0 10 10H12V2z"></path><path d="M12 12 2.1 12.1"></path><path d="M12 12l8.9-5.1"></path><path d="M12 12l-8.9-5.1"></path></svg>
};

const Sidebar = ({ active, setActive }) => {  // active and setActive are now props

  const menuItems = [
    { name: 'Home', icon: <Icons.Home /> },
    { name: 'Notifications', icon: <Icons.Notifications /> },
    { name: 'Tasks', icon: <Icons.Tasks /> },
    { name: 'Team', icon: <Icons.Team /> },
    { name: 'Docs', icon: <Icons.Docs /> },
    { name: 'Chat', icon: <Icons.Chat /> }, 
    { name: 'Analytics', icon: <Icons.Analytics /> },
    { name: 'AI Assistant', icon: <Icons.AI /> },
  ];
